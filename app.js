...
home_button.addEventListener("click", () => {
  console.log("clicked");
  home_button.innerHTML = `Please mail me at <a href='mailto:kirnapure24@gmail.com' style="text-decoration: none;">kirnapure24@gmail.com</a>`;
});

// Blinking "Hello" Tag
let hello = document.querySelector("#helloTag");

function changeColor(color, delay = 850) {
...
var typed = new Typed(".text-three", {
  strings: ["Software Developer", "Android App Developer"],
  typeSpeed: 50,
  backSpeed: 25,
  loop: true,
